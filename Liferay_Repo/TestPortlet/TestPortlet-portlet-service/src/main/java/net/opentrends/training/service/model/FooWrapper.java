...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
    ...
    */
    ...
    @Override
    public int compareTo(net.opentrends.training.service.model.Foo foo) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<net.opentrends.training.service.model.Foo> toCacheModel() {
        return _foo.toCacheModel();
    }

    @Override
    public net.opentrends.training.service.model.Foo toEscapedModel() {
        return new FooWrapper(_foo.toEscapedModel());
    }

    @Override
    public net.opentrends.training.service.model.Foo toUnescapedModel() {

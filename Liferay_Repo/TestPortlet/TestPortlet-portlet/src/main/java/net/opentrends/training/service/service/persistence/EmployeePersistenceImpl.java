...
public class EmployeePersistenceImpl extends BasePersistenceImpl<Employee>
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_SITEID = new FinderPath(EmployeeModelImpl.ENTITY_CACHE_ENABLED,
            EmployeeModelImpl.FINDER_CACHE_ENABLED, EmployeeImpl.class,
    ...
    public static final FinderPath FINDER_PATH_COUNT_BY_SITEID = new FinderPath(EmployeeModelImpl.ENTITY_CACHE_ENABLED,
            EmployeeModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBysiteId",
            new String[] { Long.class.getName() });
    private static final String _FINDER_COLUMN_SITEID_GROUPID_2 = "employee.groupId = ?";
    ...
    private static final String _FILTER_SQL_SELECT_EMPLOYEE_WHERE = "SELECT DISTINCT {employee.*} FROM TestPortlet_Employee employee WHERE ";
    private static final String _FILTER_SQL_SELECT_EMPLOYEE_NO_INLINE_DISTINCT_WHERE_1 =
        "SELECT {TestPortlet_Employee.*} FROM (SELECT DISTINCT employee.employeeId FROM TestPortlet_Employee employee WHERE ";
    private static final String _FILTER_SQL_SELECT_EMPLOYEE_NO_INLINE_DISTINCT_WHERE_2 =
        ") TEMP_TABLE INNER JOIN TestPortlet_Employee ON TEMP_TABLE.employeeId = TestPortlet_Employee.employeeId";
    private static final String _FILTER_SQL_COUNT_EMPLOYEE_WHERE = "SELECT COUNT(DISTINCT employee.employeeId) AS COUNT_VALUE FROM TestPortlet_Employee employee WHERE ";
    private static final String _FILTER_ENTITY_ALIAS = "employee";
    private static final String _FILTER_ENTITY_TABLE = "TestPortlet_Employee";
    private static final String _ORDER_BY_ENTITY_ALIAS = "employee.";
    private static final String _ORDER_BY_ENTITY_TABLE = "TestPortlet_Employee.";
     ...
     */
    @Override
    public List<Employee> findBysiteId(long groupId) throws SystemException {
        return findBysiteId(groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
    }
     ...
     */
    @Override
    public List<Employee> findBysiteId(long groupId, int start, int end)
        throws SystemException {
        return findBysiteId(groupId, start, end, null);
    }
    ...
    public List<Employee> findBysiteId(long groupId, int start, int end,
        ...
        if (list == null) {
            ...
            query.append(_FINDER_COLUMN_SITEID_GROUPID_2);
     ...
     */
    @Override
    public Employee findBysiteId_First(long groupId,
        OrderByComparator orderByComparator)
        throws NoSuchEmployeeException, SystemException {
        Employee employee = fetchBysiteId_First(groupId, orderByComparator);
     ...
     */
    @Override
    public Employee fetchBysiteId_First(long groupId,
        OrderByComparator orderByComparator) throws SystemException {
        List<Employee> list = findBysiteId(groupId, 0, 1, orderByComparator);
     ...
     */
    @Override
    public Employee findBysiteId_Last(long groupId,
        OrderByComparator orderByComparator)
        throws NoSuchEmployeeException, SystemException {
        Employee employee = fetchBysiteId_Last(groupId, orderByComparator);
     ...
     */
    @Override
    public Employee fetchBysiteId_Last(long groupId,
        OrderByComparator orderByComparator) throws SystemException {
        int count = countBysiteId(groupId);

        if (count == 0) {
            return null;
        }

        List<Employee> list = findBysiteId(groupId, count - 1, count,
                orderByComparator);
     ...
     */
    @Override
    public Employee[] findBysiteId_PrevAndNext(long employeeId, long groupId,
        OrderByComparator orderByComparator)
        throws NoSuchEmployeeException, SystemException {
        ...
        try {
            ...
            array[0] = getBysiteId_PrevAndNext(session, employee, groupId,
                    orderByComparator, true);

            array[1] = employee;

            array[2] = getBysiteId_PrevAndNext(session, employee, groupId,
    ...
    protected Employee getBysiteId_PrevAndNext(Session session,
     ...
     */
    @Override
    public List<Employee> filterFindBysiteId(long groupId)
        throws SystemException {
        return filterFindBysiteId(groupId, QueryUtil.ALL_POS,
     ...
     */
    @Override
    public List<Employee> filterFindBysiteId(long groupId, int start, int end)
        throws SystemException {
        return filterFindBysiteId(groupId, start, end, null);
    }
    ...
    public List<Employee> filterFindBysiteId(long groupId, int start, int end,
        ...
        if (!InlineSQLHelperUtil.isEnabled(groupId)) {
            return findBysiteId(groupId, start, end, orderByComparator);
        }
     ...
     */
    @Override
    public Employee[] filterFindBysiteId_PrevAndNext(long employeeId,
        long groupId, OrderByComparator orderByComparator)
        throws NoSuchEmployeeException, SystemException {
        if (!InlineSQLHelperUtil.isEnabled(groupId)) {
            return findBysiteId_PrevAndNext(employeeId, groupId,
                orderByComparator);
        }
        ...
        try {
            ...
            array[0] = filterGetBysiteId_PrevAndNext(session, employee,
                    groupId, orderByComparator, true);

            array[1] = employee;

            array[2] = filterGetBysiteId_PrevAndNext(session, employee,
    ...
    protected Employee filterGetBysiteId_PrevAndNext(Session session,
        Employee employee, long groupId, OrderByComparator orderByComparator,
        boolean previous) {
        StringBundler query = null;
     ...
     */
    @Override
    public void removeBysiteId(long groupId) throws SystemException {
        for (Employee employee : findBysiteId(groupId, QueryUtil.ALL_POS,
                QueryUtil.ALL_POS, null)) {
            remove(employee);
        }
    }
     ...
     */
    @Override
    public int countBysiteId(long groupId) throws SystemException {
     ...
     */
    @Override
    public int filterCountBysiteId(long groupId) throws SystemException {
        if (!InlineSQLHelperUtil.isEnabled(groupId)) {
            return countBysiteId(groupId);
        }

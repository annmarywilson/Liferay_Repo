...
import net.opentrends.register.NoSuchStudentException;
import net.opentrends.register.model.Student;
import net.opentrends.register.model.impl.StudentImpl;
import net.opentrends.register.model.impl.StudentModelImpl;
import net.opentrends.register.service.persistence.StudentPersistence;
...
public class StudentPersistenceImpl extends BasePersistenceImpl<Student>
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_SITEID = new FinderPath(StudentModelImpl.ENTITY_CACHE_ENABLED,
            StudentModelImpl.FINDER_CACHE_ENABLED, StudentImpl.class,
    ...
    public static final FinderPath FINDER_PATH_COUNT_BY_SITEID = new FinderPath(StudentModelImpl.ENTITY_CACHE_ENABLED,
            StudentModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBysiteId",
            new String[] { Long.class.getName() });
    private static final String _FINDER_COLUMN_SITEID_GROUPID_2 = "student.groupId = ?";
     ...
     */
    @Override
    public List<Student> findBysiteId(long groupId) throws SystemException {
     ...
     */
    @Override
    public List<Student> findBysiteId(long groupId, int start, int end)
     ...
     */
    @Override
    public Student findBysiteId_First(long groupId,
        OrderByComparator orderByComparator)
        throws NoSuchStudentException, SystemException {
        Student student = fetchBysiteId_First(groupId, orderByComparator);
     ...
     */
    @Override
    public Student fetchBysiteId_First(long groupId,
        OrderByComparator orderByComparator) throws SystemException {
        List<Student> list = findBysiteId(groupId, 0, 1, orderByComparator);
     ...
     */
    @Override
    public Student findBysiteId_Last(long groupId,
        OrderByComparator orderByComparator)
        throws NoSuchStudentException, SystemException {
        Student student = fetchBysiteId_Last(groupId, orderByComparator);
     ...
     */
    @Override
    public Student fetchBysiteId_Last(long groupId,
        OrderByComparator orderByComparator) throws SystemException {
        ...
        List<Student> list = findBysiteId(groupId, count - 1, count,
                orderByComparator);
     ...
     */
    @Override
    public Student[] findBysiteId_PrevAndNext(long studentId, long groupId,
        OrderByComparator orderByComparator)
        throws NoSuchStudentException, SystemException {
        ...
        try {
            ...
            array[0] = getBysiteId_PrevAndNext(session, student, groupId,
                    orderByComparator, true);

            array[1] = student;

            array[2] = getBysiteId_PrevAndNext(session, student, groupId,
    ...
    protected Student getBysiteId_PrevAndNext(Session session, Student student,
    ...
    public void removeBysiteId(long groupId) throws SystemException {
        for (Student student : findBysiteId(groupId, QueryUtil.ALL_POS,
    ...
    @Override
    public Student updateImpl(net.opentrends.register.model.Student student)
        throws SystemException {
        student = toUnwrappedModel(student);
    ...
    protected Student toUnwrappedModel(Student student) {
        ...
        studentImpl.setStudentClass(student.getStudentClass());
        studentImpl.setStudentEmail(student.getStudentEmail());
        studentImpl.setPhoneNumber(student.getPhoneNumber());
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.net.opentrends.register.model.Student")));

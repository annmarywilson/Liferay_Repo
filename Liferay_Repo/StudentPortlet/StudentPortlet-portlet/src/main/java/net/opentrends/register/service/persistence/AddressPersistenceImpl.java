...
import net.opentrends.register.NoSuchAddressException;
import net.opentrends.register.model.Address;
import net.opentrends.register.model.impl.AddressImpl;
import net.opentrends.register.model.impl.AddressModelImpl;
import net.opentrends.register.service.persistence.AddressPersistence;
...
public class AddressPersistenceImpl extends BasePersistenceImpl<Address>
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_SITEID = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
            AddressModelImpl.FINDER_CACHE_ENABLED, AddressImpl.class,
    ...
    public static final FinderPath FINDER_PATH_COUNT_BY_SITEID = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
            AddressModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBysiteId",
            new String[] { Long.class.getName() });
    private static final String _FINDER_COLUMN_SITEID_GROUPID_2 = "address.groupId = ?";
     ...
     */
    @Override
    public List<Address> findBysiteId(long groupId) throws SystemException {
     ...
     */
    @Override
    public List<Address> findBysiteId(long groupId, int start, int end)
     ...
     */
    @Override
    public Address findBysiteId_First(long groupId,
        OrderByComparator orderByComparator)
        throws NoSuchAddressException, SystemException {
        Address address = fetchBysiteId_First(groupId, orderByComparator);
     ...
     */
    @Override
    public Address fetchBysiteId_First(long groupId,
        OrderByComparator orderByComparator) throws SystemException {
        List<Address> list = findBysiteId(groupId, 0, 1, orderByComparator);
     ...
     */
    @Override
    public Address findBysiteId_Last(long groupId,
        OrderByComparator orderByComparator)
        throws NoSuchAddressException, SystemException {
        Address address = fetchBysiteId_Last(groupId, orderByComparator);
     ...
     */
    @Override
    public Address fetchBysiteId_Last(long groupId,
        OrderByComparator orderByComparator) throws SystemException {
        ...
        List<Address> list = findBysiteId(groupId, count - 1, count,
                orderByComparator);
     ...
     */
    @Override
    public Address[] findBysiteId_PrevAndNext(long addressId, long groupId,
        OrderByComparator orderByComparator)
        throws NoSuchAddressException, SystemException {
        ...
        try {
            ...
            array[0] = getBysiteId_PrevAndNext(session, address, groupId,
                    orderByComparator, true);

            array[1] = address;

            array[2] = getBysiteId_PrevAndNext(session, address, groupId,
    ...
    protected Address getBysiteId_PrevAndNext(Session session, Address address,
    ...
    public void removeBysiteId(long groupId) throws SystemException {
        for (Address address : findBysiteId(groupId, QueryUtil.ALL_POS,
    ...
    @Override
    public Address updateImpl(net.opentrends.register.model.Address address)
        throws SystemException {
        address = toUnwrappedModel(address);
    ...
    protected Address toUnwrappedModel(Address address) {
        ...
        addressImpl.setStudentId(address.getStudentId());
        addressImpl.setGroupId(address.getGroupId());
        addressImpl.setParentAddress(address.getParentAddress());
        addressImpl.setParentState(address.getParentState());
        addressImpl.setParentDistrict(address.getParentDistrict());
        addressImpl.setParentPin(address.getParentPin());
        addressImpl.setParentPhone(address.getParentPhone());
        addressImpl.setParentMail(address.getParentMail());
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.net.opentrends.register.model.Address")));

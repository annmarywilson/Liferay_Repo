 ...
 * {@link net.opentrends.register.service.impl.StudentLocalServiceImpl} and is the
 ...
 * @see net.opentrends.register.service.base.StudentLocalServiceBaseImpl
 * @see net.opentrends.register.service.impl.StudentLocalServiceImpl
 * @generated
 */
public class StudentLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link net.opentrends.register.service.impl.StudentLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static net.opentrends.register.model.Student addStudent(
    ...
    */
    public static net.opentrends.register.model.Student createStudent(
        long studentId) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.register.model.Student deleteStudent(
        long studentId)
    ...
    */
    ...
    public static net.opentrends.register.model.Student fetchStudent(
        long studentId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.register.model.Student getStudent(
        long studentId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<net.opentrends.register.model.Student> getStudents(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.register.model.Student updateStudent(
        net.opentrends.register.model.Student student)
        throws com.liferay.portal.kernel.exception.SystemException {

...
public interface StudentLocalService extends BaseLocalService,
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link StudentLocalServiceUtil} to access the student local service. Add custom service methods to {@link net.opentrends.register.service.impl.StudentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
    ...
    */
    ...
    public net.opentrends.register.model.Student addStudent(
    ...
    */
    public net.opentrends.register.model.Student createStudent(long studentId);
    ...
    */
    ...
    public net.opentrends.register.model.Student deleteStudent(long studentId)
    ...
    */
    @com.liferay.portal.kernel.search.Indexable(type = IndexableType.DELETE)
    public net.opentrends.register.model.Student deleteStudent(
        net.opentrends.register.model.Student student)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    ...
    public net.opentrends.register.model.Student fetchStudent(long studentId)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public net.opentrends.register.model.Student getStudent(long studentId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public java.util.List<net.opentrends.register.model.Student> getStudents(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
    public net.opentrends.register.model.Student updateStudent(
        net.opentrends.register.model.Student student)
        throws com.liferay.portal.kernel.exception.SystemException;
